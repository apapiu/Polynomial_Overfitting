...
s = .5 #this is really sigma squared
set.seed(132)
...
colnames(testdf)[1]<-"x"
plot(test, predict(poly,test), ylim = c(-2,3), xlab = "x", ylab = "y", sub = "$g_10$ outperforms $g_2$",
     main = "Noisy 5th Degree Polynomial with 40 Data Points")
